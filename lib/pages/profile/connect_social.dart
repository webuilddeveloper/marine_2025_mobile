            ...
            child: Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  filled: true,
                  fillColor: showIsEdit ? const Color(0xFFC5DAFC) : const Color(0xFF707070),
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    filled: true,
                    fillColor:
                        showIsEdit ? const Color(0xFFC5DAFC) : const Color(0xFF707070),
                    contentPadding: const EdgeInsets.fromLTRB(5.0, 5.0, 5.0, 5.0),
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            margin: const EdgeInsets.only(left: 0.0, right: 2.0),
            child: Text(
              getIDSocial == '' ? 'เชื่อมต่อ' : 'ยกเลิกการเชื่อมต่อ',
              style: new TextStyle(
                fontSize: 14.0,
                color: getIDSocial == '' ? Colors.blue : const Color(0xFFFC4137),
                fontWeight: FontWeight.normal,
                fontFamily: 'Sarabun',
              ),
